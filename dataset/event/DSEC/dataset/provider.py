...
from dataset.event.DSEC.dataset.sequence import Sequence
...
class DatasetProvider:
    def __init__(self, dataset_path: Path, mode: str = 'train', event_representation: str = 'voxel_grid',
                 ...
                 nr_events_window=-1, nr_bins_per_data=5, require_paired_data=True, normalize_event=False,
        ...
        if mode == 'train':
            ...
            # val_sequences_namelist = ['zurich_city_14_c']
